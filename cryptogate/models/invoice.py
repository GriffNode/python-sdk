...
class Invoice(BaseModel):
    ...
    purchase_type: Optional[StrictStr] = None
    amount_fiat: Optional[Union[StrictFloat, StrictInt]] = None
    currency_fiat: Optional[FiatCurrency] = FiatCurrency.USD
    status: Optional[StrictStr] = None
    crypto_symbol: Optional[CryptoSymbol] = None
    created_at: Optional[datetime] = None
    confirmed_at: Optional[datetime] = None
    expires_at: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["transaction_id", "purchase_type", "amount_fiat", "currency_fiat", "status", "crypto_symbol", "created_at", "confirmed_at", "expires_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "crypto_symbol": obj.get("crypto_symbol"),
