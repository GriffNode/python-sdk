...
class CreateBillingCheckoutRequest(BaseModel):
    """
    CreateBillingCheckoutRequest
    """ # noqa: E501
    tier: PlanTier
    billing_months: Optional[Annotated[int, Field(strict=True, ge=1)]] = 1
    payment_method: Optional[StrictStr] = 'crypto'
    __properties: ClassVar[List[str]] = ["tier", "billing_months", "payment_method"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tier": obj.get("tier"),
            "billing_months": obj.get("billing_months") if obj.get("billing_months") is not None else 1,
            "payment_method": obj.get("payment_method") if obj.get("payment_method") is not None else 'crypto'
        })
        return _obj
