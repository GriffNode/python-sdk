...
class GetStats200ResponseData(BaseModel):
    """
    GetStats200ResponseData
    """ # noqa: E501
    total_transactions: Optional[StrictInt] = None
    monthly_transactions: Optional[StrictInt] = None
    total_volume_fiat: Optional[Union[StrictFloat, StrictInt]] = None
    unique_customers: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["total_transactions", "monthly_transactions", "total_volume_fiat", "unique_customers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "monthly_transactions": obj.get("monthly_transactions"),
            "total_volume_fiat": obj.get("total_volume_fiat"),
            "unique_customers": obj.get("unique_customers")
        })
        return _obj
