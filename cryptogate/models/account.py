...
class Account(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["plan", "usage", "limits"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "usage": AccountUsage.from_dict(obj["usage"]) if obj.get("usage") is not None else None,
            "limits": AccountLimits.from_dict(obj["limits"]) if obj.get("limits") is not None else None
        })
        return _obj
