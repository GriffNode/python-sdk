...
class GetPrices200ResponseData(BaseModel):
    ...
    """ # noqa: E501
    crypto: Optional[Dict[str, Union[StrictFloat, StrictInt]]] = Field(default=None, description="USD price per unit, keyed by crypto symbol (active coins only).")
    fiat: Optional[Dict[str, Union[StrictFloat, StrictInt]]] = Field(default=None, description="USD value of one unit of each fiat currency.")
    fetched_at: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["crypto", "fiat", "fetched_at"]
