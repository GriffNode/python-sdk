...
class Balance(BaseModel):
    ...
    pending_balance: Optional[Union[StrictFloat, StrictInt]] = None
    updated_at: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["currency", "available_balance", "pending_balance", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pending_balance": obj.get("pending_balance"),
