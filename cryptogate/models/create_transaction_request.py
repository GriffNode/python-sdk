...
class CreateTransactionRequest(BaseModel):
    ...
    """ # noqa: E501
    crypto: CryptoSymbol
    amount: Union[StrictFloat, StrictInt] = Field(description="Fiat amount (≥ 1.00 USD equivalent).")
    ...
    __properties: ClassVar[List[str]] = ["crypto", "amount", "currency_fiat", "metadata", "customer_email", "success_url", "cancel_url"]
