...
class MarketDataApi:
    ...
    def list_cryptocurrencies(
        ...
        _param = self._list_cryptocurrencies_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ListCryptocurrencies200Response",
            '401': "Error",
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def list_cryptocurrencies_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListCryptocurrencies200Response]:
        """All supported cryptocurrencies and tokens
    ...
    @validate_call
    def list_cryptocurrencies_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _list_cryptocurrencies_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    @validate_call
    def list_merchant_cryptocurrencies(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._list_merchant_cryptocurrencies_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def list_merchant_cryptocurrencies_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def list_merchant_cryptocurrencies_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _list_merchant_cryptocurrencies_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/merchant/cryptos',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
