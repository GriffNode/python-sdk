...
from cryptogate.api_response import ApiResponse, T as ApiResponseT
import cryptogate.models
from cryptogate import rest
from cryptogate.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(cryptogate.models, klass)
