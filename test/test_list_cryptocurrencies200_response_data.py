...
class TestListCryptocurrencies200ResponseData(unittest.TestCase):
    """ListCryptocurrencies200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListCryptocurrencies200ResponseData:
        """Test ListCryptocurrencies200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListCryptocurrencies200ResponseData`
        """
        model = ListCryptocurrencies200ResponseData()
        if include_optional:
            return ListCryptocurrencies200ResponseData(
                cryptocurrencies = [
    ...
    def testListCryptocurrencies200ResponseData(self):
        """Test ListCryptocurrencies200ResponseData"""
