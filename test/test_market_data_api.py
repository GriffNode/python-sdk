...
class TestMarketDataApi(unittest.TestCase):
    ...
    def test_list_cryptocurrencies(self) -> None:
        """Test case for list_cryptocurrencies

        All supported cryptocurrencies and tokens
        """
        pass

    def test_list_merchant_cryptocurrencies(self) -> None:
        """Test case for list_merchant_cryptocurrencies
