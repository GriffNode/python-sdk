...
class TestInlineObjectAllOfExistingTransaction(unittest.TestCase):
    """InlineObjectAllOfExistingTransaction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InlineObjectAllOfExistingTransaction:
        """Test InlineObjectAllOfExistingTransaction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InlineObjectAllOfExistingTransaction`
        """
        model = InlineObjectAllOfExistingTransaction()
        if include_optional:
            return InlineObjectAllOfExistingTransaction(
                transaction_id = '',
                status = 'pending',
                payment_url = ''
            )
    ...
    def testInlineObjectAllOfExistingTransaction(self):
        """Test InlineObjectAllOfExistingTransaction"""
