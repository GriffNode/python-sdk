...
class TestTransactionEnvelope(unittest.TestCase):
    """TransactionEnvelope unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransactionEnvelope:
        """Test TransactionEnvelope
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransactionEnvelope`
        """
        model = TransactionEnvelope()
        if include_optional:
            return TransactionEnvelope(
                success = None,
                data = cryptogate.models.transaction.Transaction(
                    transaction_id = '', 
                    status = 'pending', 
                    type = 'basic', 
                    crypto = 'BTC', 
    ...
    def testTransactionEnvelope(self):
        """Test TransactionEnvelope"""
