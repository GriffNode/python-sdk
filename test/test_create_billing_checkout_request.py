...
class TestCreateBillingCheckoutRequest(unittest.TestCase):
    """CreateBillingCheckoutRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateBillingCheckoutRequest:
        """Test CreateBillingCheckoutRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateBillingCheckoutRequest`
        """
        model = CreateBillingCheckoutRequest()
        if include_optional:
            return CreateBillingCheckoutRequest(
                tier = 'starter',
                billing_months = 1,
    ...
    def testCreateBillingCheckoutRequest(self):
        """Test CreateBillingCheckoutRequest"""
