...
class TestCreateDetailedTransactionRequest(unittest.TestCase):
    """CreateDetailedTransactionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateDetailedTransactionRequest:
        """Test CreateDetailedTransactionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateDetailedTransactionRequest`
        """
        model = CreateDetailedTransactionRequest()
        if include_optional:
            return CreateDetailedTransactionRequest(
                crypto = 'BTC',
                currency_fiat = 'USD',
                items = [
    ...
    def testCreateDetailedTransactionRequest(self):
        """Test CreateDetailedTransactionRequest"""
