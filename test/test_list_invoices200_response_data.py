...
class TestListInvoices200ResponseData(unittest.TestCase):
    """ListInvoices200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListInvoices200ResponseData:
        """Test ListInvoices200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListInvoices200ResponseData`
        """
        model = ListInvoices200ResponseData()
        if include_optional:
            return ListInvoices200ResponseData(
                invoices = [
                    cryptogate.models.invoice.Invoice(
                        transaction_id = '', 
                        purchase_type = '', 
                        amount_fiat = 1.337, 
                        currency_fiat = 'USD', 
    ...
    def testListInvoices200ResponseData(self):
        """Test ListInvoices200ResponseData"""
