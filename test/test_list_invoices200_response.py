...
class TestListInvoices200Response(unittest.TestCase):
    """ListInvoices200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListInvoices200Response:
        """Test ListInvoices200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListInvoices200Response`
        """
        model = ListInvoices200Response()
        if include_optional:
            return ListInvoices200Response(
                success = None,
                data = cryptogate.models.list_invoices_200_response_data.listInvoices_200_response_data(
                    invoices = [
    ...
    def testListInvoices200Response(self):
        """Test ListInvoices200Response"""
