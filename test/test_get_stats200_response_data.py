...
class TestGetStats200ResponseData(unittest.TestCase):
    """GetStats200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetStats200ResponseData:
        """Test GetStats200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetStats200ResponseData`
        """
        model = GetStats200ResponseData()
        if include_optional:
            return GetStats200ResponseData(
    ...
    def testGetStats200ResponseData(self):
        """Test GetStats200ResponseData"""
