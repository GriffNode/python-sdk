...
class TestPaymentSplit(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaymentSplit:
        """Test PaymentSplit
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentSplit`
        """
        model = PaymentSplit()
        if include_optional:
            return PaymentSplit(
