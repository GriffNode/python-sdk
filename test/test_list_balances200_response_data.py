...
class TestListBalances200ResponseData(unittest.TestCase):
    """ListBalances200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListBalances200ResponseData:
        """Test ListBalances200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListBalances200ResponseData`
        """
        model = ListBalances200ResponseData()
        if include_optional:
            return ListBalances200ResponseData(
                balances = [
    ...
    def testListBalances200ResponseData(self):
        """Test ListBalances200ResponseData"""
