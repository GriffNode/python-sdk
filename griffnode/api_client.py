...
from griffnode.api_response import ApiResponse, T as ApiResponseT
import griffnode.models
from griffnode import rest
from griffnode.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(griffnode.models, klass)
